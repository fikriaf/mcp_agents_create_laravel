  ...
  <header class="fixed w-full bg-[var(--secondary)] z-50 shadow-lg">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
      ...
      <nav class="hidden md:flex space-x-8">
        <a href="{{ route('features') }}" class="text-[var(--text-secondary)] hover:text-[var(--primary)] transition">Features</a>
        <a href="#testimonials" class="text-[var(--text-secondary)] hover:text-[var(--primary)] transition">Testimonials</a>
        <a href="{{ route('features') }}" class="text-[var(--text-secondary)] hover:text-[var(--primary)] transition">Use Cases</a>
        <a href="{{ route('contact') }}" class="text-[var(--text-secondary)] hover:text-[var(--primary)] transition">Contact</a>
      </nav>
    ...
    <div id="mobileMenu" class="md:hidden hidden bg-[var(--secondary)] py-4 px-4">
      <div class="flex flex-col space-y-4">
        <a href="{{ route('features') }}" class="text-[var(--text-secondary)] hover:text-[var(--primary)]">Features</a>
        <a href="#testimonials" class="text-[var(--text-secondary)] hover:text-[var(--primary)]">Testimonials</a>
        <a href="{{ route('features') }}" class="text-[var(--text-secondary)] hover:text-[var(--primary)]">Use Cases</a>
        <a href="{{ route('contact') }}" class="text-[var(--text-secondary)] hover:text-[var(--primary)]">Contact</a>
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li><a href="{{ route('features') }}" class="hover:text-[var(--primary)]">Features</a></li>
            <li><a href="{{ route('contact') }}" class="hover:text-[var(--primary)]">Contact</a></li>
          </ul>
        </div>
        <div>
